...
![](assets/shiny/merigolix_dashboard.png){width="100%"}
:::
::: {.column width="48%"}
...
```{=html}
<iframe src="https://pipetqsp.shinyapps.io/merigolix/" width="100%" height="600"
        style="border:1px solid #D9E1E8; border-radius:8px; background:#fff;"
        loading="lazy" referrerpolicy="no-referrer"></iframe>
```

[Live app → **pipetqsp.shinyapps.io/merigolix** — move the sliders during the talk.]{.fineprint}
