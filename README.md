...
| 2026-06-19 | [**Abdominal Aortic Aneurysm — AAA (복부 대동맥류)**](#abdominal-aortic-aneurysm-aaa) | 만성질환 / 심혈관·혈관 | 복부 대동맥류: 혈역학적 스트레스(벽 전단응력↓·LaPlace 법칙→벽 스트레스↑) + 흡연/고령/고혈압 위험인자 → 내피세포 기능장애(eNOS 탈커플링→NO↓·ICAM-1/VCAM-1↑) → 단핵구/대식세포(M1) 침윤 → MMP-2(젤라티나아제A)/MMP-9(젤라티나아제B)/MMP-12(대식세포 엘라스타아제) 활성화 → 탄력소(elastin) 및 콜라겐 분해 → ECM 턴오버 불균형; VSMC 세포사멸(TNF-α·MMP-9·ROS 매개 anoikis) → 혈관 벽 구조 약화; NADPH산화효소→초과산화물(O₂•⁻)→ROS→NF-κB 증폭; 내강내 혈전(ILT) 성장→국소 저산소증→추가 MMP 방출; 임상 엔드포인트: 대동맥 최대 직경(mm)·팽창 속도(mm/yr)·파열 위험(55mm 임계값); 약물 PK/PD: 독시사이클린(MMP-2/9/12 아연 킬레이트 직접 억제, Imax=0.85, IC50_tissue=0.20mg/L, t½=18h, PHAST-1/2 임상 근거) + 심바스타틴(HMG-CoA억제+NF-κB↓·ROS↓·MMP-9↓ 다면발현, IC50_MMP9=0.05mg/L) + 프로프라놀롤(β1 차단→HR↓·SBP↓→대동맥 벽 스트레스 감소, Imax_BP=0.20, UK Small Aneurysm Trial); 20-CMT mrgsolve ODE(PK 9개: 독시사이클린 4구획+스타틴 3구획+프로프라놀롤 3구획; PD 11개: MAC·TNF·ROS·MMP9·MMP2·ELASTIN·COLLAGEN·VSMC·ILT·WALL_INTEGRITY·DIAMETER); 6 치료 시나리오(무치료·독시사이클린 BID·스타틴 QD·프로프라놀롤 TID·독시사이클린+스타틴·3제 병용요법); Shiny 6탭(환자프로파일·PK·MMP바이오마커·대동맥벽역학·시나리오비교·파열위험평가); 보정: Sweeting 2012(BJS, 팽창률 2mm/yr)·SVS 가이드라인 2018(55mm 수술 임계값)·PHAST-1(Lindeman 2009 Circulation)·PHAST-2(Meijer 2013 Ann Intern Med)·Brady 2004(Circulation, 스타틴 팽창억제) | [![AAA](abdominal-aortic-aneurysm/aaa_qsp_model.png)](abdominal-aortic-aneurysm/aaa_qsp_model.svg) | [R](abdominal-aortic-aneurysm/aaa_mrgsolve_model.R) | [refs](abdominal-aortic-aneurysm/aaa_references.md) | [Shiny](abdominal-aortic-aneurysm/aaa_shiny_app.R) |
...
| 2026-06-19 | [**Minimal Change Disease — MCD (미세변화 신증후군)**](#minimal-change-disease) | 만성질환 / 신장 | 미세변화 신증후군(MCD): HLA-DR7·HLA-DQB1·NPHS1·NPHS2·WT1·PLCE1·LAMB2 유전 소인 + 바이러스 감염(EBV·CMV·RSV)·NSAID·백신·알레르겐·림프종(흉선종·호지킨) 유발인자 → TLR 활성화 → pDC IFN-α/β + mDC IL-12; TCR→ZAP70→LAT→PLCγ1→IP3/DAG/Ca2+→Calcineurin→NFAT/NF-κB/AP-1 → Th0 분극화 → Th2(IL-4·IL-5·IL-13·IL-25·IL-33) 우세 + Treg(FOXP3·IL-10·TGF-β) 기능 저하; Tfh(CXCR5·IL-21) → GC 반응 → B세포 활성화 → 형질세포 → 항-네프린 IgG4 항체(Beck 2023 NEJM; MCD 환자 64%에서 발견); 가용성 투과인자: suPAR(정상 1.4 ng/mL→MCD 활성기 3+ ng/mL)·hemopexin·CLC-1·VEGF → 족세포 β3 인테그린 활성화·αvβ3 신호 → 족세포 손상; 항-네프린 IgG4 → 슬릿 다이어프램 분자 교란(Nephrin-Podocin-CD2AP-Neph1·ZO-1·synaptopodin 복합체 해리) → Cofilin-1·RhoA/Rac1/Cdc42 불균형 → 액틴 세포골격 불안정 → 족돌기 소실(FPE); GBM(Laminin-521·Collagen IV α3α4α5·HSPG·agrin) 및 내피 당칼릭스(Syndecan-4·Glypican-1) 기능 감소 → 사구체 여과 선택성 상실 → 대량 단백뇨(>3.5 g/day) + 지질뇨; 저알부민혈증(<25 g/L) → 교질삼투압↓ → RAAS(Renin→AngII→Aldosterone)·ANP·AQP2 활성 → Na/수분 저류 → 부종(안와주위·함요부종·복수·흉수); 간 VLDL 과다 생성+LPL 감소+PCSK9↑ → 고콜레스테롤혈증·고중성지방혈증·지질뇨; AT-III·단백S·단백C 소실 → 과응고 → DVT/PE·신정맥혈전증 위험; 치료 PK/PD: 프레드니솔론(60 mg/day 표준; F=82%·Vc=28L·CL=16.3L/h·EC50=2.5 ng/mL→CD4 Emax=85%↓; KDIGO 2021 CR 88% 12주); 사이클로스포린(3–5 mg/kg/day; C0 목표 100–200 ng/mL·F=35%·Faul 2008 Nat Med: 족세포 Synaptopodin-Cofilin 직접 안정화); 타크로리무스(0.05–0.1 mg/kg/day BID; C0 목표 4–8 ng/mL); 리투시맙(375 mg/m²×4회; TMDD CD20 고갈 98%·B세포 회복 6–9개월; Iijima 2014 Lancet: 무재발 267 vs 101일); MMF→MPA(IMPDH IC50=0.07 μg/mL→퓨린 합성 차단·B세포 증식↓); 사이클로포스파미드(4-OH-CP→DNA 알킬화; 2년 무재발 40–50%); 21-CMT mrgsolve ODE(9PK+5면역/PD+7질환); 6 치료 시나리오(무치료·Pred 단독·Pred+CsA·Pred+Tac·Rituximab·CYC+Pred); 보정: Beck 2023(NEJM 항-네프린Ab)·Iijima 2014(RITAR-FP)·KDIGO 2021·Waldman 2007(성인코호트CR율)·Faul 2008(CNI 족세포 직접 효과)·Wei 2011(suPAR Nat Med)·Kemper 2020(RTX 메타분석) | [![MCD](minimal-change-disease/mcd_qsp_model.png)](minimal-change-disease/mcd_qsp_model.svg) | [R](minimal-change-disease/mcd_mrgsolve_model.R) | [refs](minimal-change-disease/mcd_references.md) | [Shiny](minimal-change-disease/mcd_shiny_app.R) |
...
## Abdominal Aortic Aneurysm (AAA) — 복부 대동맥류

> Directory: [`abdominal-aortic-aneurysm/`](abdominal-aortic-aneurysm/)

**Mechanistic Map** (130+ nodes, 13 pathway clusters):

[![AAA QSP Map](abdominal-aortic-aneurysm/aaa_qsp_model.png)](abdominal-aortic-aneurysm/aaa_qsp_model.svg)

### 질환 개요 (Disease Overview)

복부 대동맥류(AAA)는 복부 대동맥 직경이 3 cm 이상으로 비정상적으로 확장된 상태로, 파열 시 사망률이 80% 이상에 달하는 치명적인 혈관 질환입니다. 주요 위험인자는 흡연, 고령(>65세), 남성, 가족력, 고혈압이며, 유병률은 65세 이상 남성에서 약 4–8%입니다.

### 병태생리 핵심 (Key Pathophysiology)

| 경로 | 기전 | 핵심 분자 |
|------|------|----------|
| MMP 매개 ECM 분해 | MMP-2/9/12가 elastin·collagen 분해 | MMP-9★, MMP-2★, MMP-12, TIMP-1/2 |
| 대식세포/염증 축 | M1 대식세포→TNF-α/IL-1β/IL-6/MMP 분비 | NF-κB, TNF-α, IL-8, MAC_M1 |
| VSMC 소실 | MMP-9+TNF-α+ROS → anoikis | VSMC 밀도↓, α-SMA, MYH11 |
| 산화 스트레스 | NADPH 산화효소→O₂•⁻→ROS→NF-κB 증폭 | NOX, ROS, NRF2, ox-LDL |
| 내강내 혈전(ILT) | 난류→혈소판→피브린→ILT→저산소증+MMP | ILT 용적, t-PA/PAI-1 |
| 혈역학 | LaPlace 법칙 → 벽 스트레스 → 팽창 | SBP, DIAM, Wall Stress idx |

### 약물 PK/PD (Drug PK/PD Mechanisms)

| 약물 | 기전 | 주요 파라미터 | 임상 근거 |
|------|------|--------------|-----------|
| **독시사이클린 (Doxycycline)** | MMP-2, MMP-9, MMP-12 직접 억제 (zinc chelation) | Imax=0.85, IC50_tissue=0.20 mg/L, t½=18h | PHAST-1/2 (Lindeman 2009, Meijer 2013) |
| **심바스타틴 (Simvastatin)** | HMG-CoA 억제 + NF-κB↓, ROS↓, MMP-9↓ 다면발현 | MMP-9 Imax=0.40, IC50=0.05 mg/L | Brady 2004, Meijer 2012 |
| **프로프라놀롤 (Propranolol)** | β1 차단→HR↓, SBP↓→대동맥 벽 스트레스 감소 | BP Imax=0.20, IC50=0.02 mg/L | UK Small Aneurysm Trial (2002) |

### 모델 구조 (mrgsolve ODE Model)

- **총 20개 ODE 구획** (PK 9개 + PD 11개)
  - 독시사이클린: GUT → CENTRAL → PERIPHERAL + AORTIC_TISSUE (4구획)
  - 스타틴: GUT → LIVER → CENTRAL (3구획)
  - 프로프라놀롤: GUT → CENTRAL → PERIPHERAL (3구획)
  - PD (11개): MAC · TNF · ROS · MMP9 · MMP2 · ELASTIN · COLLAGEN · VSMC · ILT · WALL_INTEGRITY · DIAMETER
- **6가지 치료 시나리오**:
  1. 무치료 (자연 경과)
  2. 독시사이클린 100mg BID
  3. 심바스타틴 40mg QD
...
| 6 | Rupture Risk Assessment | 현재 환자 파열 위험 추정 + 5년 장기 예측 |

### 핵심 임상시험 (Key Clinical Trials)

- **PHAST-1** (Lindeman 2009, *Circulation*): 독시사이클린 100mg/day → AAA 조직의 호중구·CTL 선택적 감소, MMP-9 활성 저하
- **PHAST-2** (Meijer 2013, *Ann Intern Med*): 독시사이클린 18개월 투여 → MMP-9 유의미하게 감소; 직경 성장 억제는 통계적 유의성 미달
- **UK Small Aneurysm Trial** (2002, *NEJM*): 직경 4.0–5.5cm AAA에서 즉각 수술 vs 감시 비교; 장기 예후 동등
- **Propranolol Aneurysm Trial** (2002, *J Vasc Surg*): 프로프라놀롤은 단독으로 성장 억제 효과 미입증
...
- **★ 주요 표적**: Active MMP-2, Active MMP-9, VSMC Apoptosis, Rupture Risk (적색 강조)
- **엣지 색상**: 파란색=약물 억제 효과 / 녹색=내인성 억제 / 검정=활성화 경로

### 파일 목록

```
abdominal-aortic-aneurysm/
├── aaa_qsp_model.dot      # Graphviz 기계론적 지도 (130+ 노드, 13 클러스터)
├── aaa_qsp_model.svg      # SVG 벡터 이미지
├── aaa_qsp_model.png      # PNG 이미지 (150 dpi)
├── aaa_mrgsolve_model.R   # mrgsolve ODE 모델 (20 구획, 6 치료 시나리오)
├── aaa_shiny_app.R        # Shiny 대시보드 (6 탭, plotly 인터랙티브)
└── aaa_references.md      # 참고문헌 50개 (PubMed 링크, 14 섹션)
```

---

## Bronchiectasis — 기관지 확장증 (BEX) {#bronchiectasis}

> **추가일:** 2026-06-19 | **디렉토리:** [`bronchiectasis/`](bronchiectasis/)

[![BEX QSP Map](bronchiectasis/bex_qsp_model.png)](bronchiectasis/bex_qsp_model.svg)

### 질환 개요 (Disease Overview)

기관지 확장증은 기도의 비가역적 확장과 구조 손상이 특징인 만성 화농성 폐질환으로, **감염-염증-구조 손상의 악순환(Cole's Vicious Cycle)**을 통해 진행합니다. 비CF 기관지 확장증은 전 세계적으로 유병률이 증가하는 추세이며, 중증 환자(BSI ≥9)는 연간 사망률이 15–20%에 달합니다.

### 병태생리 핵심 경로

| 경로 | 핵심 분자 | 결과 |
|------|----------|------|
| MCC 기능 부전 | ASL 고갈, CFTR 이상, 섬모 기능 장애 | 점액 정체 → 균 집락 |
| 세균 집락 | PA/HI 바이오필름, 쿼럼 센싱 | 지속 감염, 항생제 내성 |
| 호중구 동원 | IL-8, LTB4, C5a | 산화 폭발, NE·MMP 방출 |
| Protease-Antiprotease 불균형 | NE > α1-AT, MMP9 > TIMP | 기도 탄성조직 파괴 |
| 구조 리모델링 | TGF-β, 콜라겐 침착 | 기도 확장, 벽 비후 |

### 약물 PK/PD (Drug PK/PD Mechanisms)

| 약물 | 기전 | 주요 파라미터 | 임상 근거 |
|------|------|--------------|-----------|
| **아지트로마이신** | NF-κB↓·IL-8↓·쿼럼센싱↓·바이오필름 억제 (비항균 항염) | Vd=31 L/kg, t½=68h, F=37%, ELF=10× | EMBRACE (Lancet 2012), AZISAST (JAMA 2013) |
| **흡입 토브라마이신** | PA 직접 살균(Emax 85%), 전신 흡수 최소 | 폐 ELF >1000 µg/mL, 전신 10% | RESPIRE (Eur Respir J 2014) |
| **시프로플록사신** | AUC/MIC≥125(농도 의존형), PA 살균 | F=70%, Vd=2.5 L/kg, ELF=0.6× | Multiple RCTs |
| **도르나제알파** | eDNA 소화 → 점도↓ → MCC↑ | 폐 국소, Kd=0.3 h⁻¹ | HINT (Respir Med 2011) |
| **브렌소카팁** | DPP-1 억제 → NE 전구체 차단 | Phase 3 완료 | ASPEN (NEJM 2024) |

### mrgsolve ODE 모델 구조

- **총 23개 ODE 구획** (PK 8개 + PD 8개 + 연계 상태 7개)
  - AZM: GUT → CENTRAL → PERIPHERAL (3구획)
  - 흡입 Tobramycin: LUNG → SYSTEMIC (2구획)
  - Ciprofloxacin: GUT → PLASMA (2구획)
  - Dornase Alfa: LUNG (1구획)
  - 질환 상태: BACT · BIOFILM · NEUT · IL8 · NE · MCC · AD · EXAC (8구획)
- **6가지 치료 시나리오**:
  1. 무치료 (자연 경과 — 악순환 진행)
  2. 아지트로마이신 250 mg 3×/week (EMBRACE 프로토콜)
  3. 흡입 토브라마이신 300 mg BID 28일 on/off 사이클
  4. 아지트로마이신 + 흡입 토브라마이신 병용
  5. AZM + TIP + 도르나제알파 (집중 유지요법)
  6. 급성악화 치료: 시프로플록사신 500 mg BID × 14일

### Shiny 앱 탭 구성

| # | 탭 | 주요 내용 |
|---|---|---------|
| 1 | Patient Profile | BSI 중증도, 기저 상태, 악순환 요약 |
| 2 | Drug PK | AZM·TIP·Cipro·DNase 폐/혈장 농도 시뮬레이션 |
| 3 | PD Biomarkers | IL-8·NE·세균 부하·바이오필름·MCC·호중구 |
| 4 | Lung Function | FEV1 추세, 기도 손상 지수, 구조 변화 |
| 5 | Scenario Comparison | 6개 치료 시나리오 직접 비교 |
| 6 | Exacerbation & Prognosis | 급성악화 역학, 5년 FEV1 궤적, 예후 요약 |

### 핵심 임상시험 (Key Clinical Trials)

- **EMBRACE** (Wong 2012, *Lancet*): AZM 250mg 3×/wk → 급성악화율 RR 0.38 (0.26–0.54), 가래량 47%↓
- **AZISAST** (Altenburg 2013, *JAMA*): AZM 250mg/day → 비화농성 악화 빈도 의미있게 감소
- **BLESS** (Serisier 2013, *JAMA*): 에리트로마이신 400mg BID → 악화 빈도 감소, PA 집락 주의
- **RESPIRE 1/2** (Haworth/Barker 2014): 흡입 시프로플록사신 DPI → PA 세균 부하↓, 일부 악화 감소
- **ASPEN** (Chalmers 2024, *NEJM*): 브렌소카팁(DPP-1 억제제) → NE 억제·악화율 유의하게 감소

### 파일 목록

```
bronchiectasis/
├── bex_qsp_model.dot      # Graphviz 기계론적 지도 (120+ 노드, 15 클러스터)
├── bex_qsp_model.svg      # SVG 벡터 이미지
├── bex_qsp_model.png      # PNG 이미지 (150 dpi)
...
## Minimal Change Disease — 미세변화 신증후군 (MCD) {#minimal-change-disease}

> **추가일:** 2026-06-19 | **디렉토리:** [`minimal-change-disease/`](minimal-change-disease/)

[![MCD QSP Map](minimal-change-disease/mcd_qsp_model.png)](minimal-change-disease/mcd_qsp_model.svg)

### 질환 개요 (Disease Overview)

미세변화 신증후군(Minimal Change Disease, MCD)은 **광학현미경상 사구체 구조가 정상**이지만, 전자현미경에서 족세포(podocyte)의 족돌기 소실(foot process effacement)이 특징적으로 관찰되는 신증후군의 가장 흔한 원인 질환입니다. 소아 신증후군의 약 70–80%, 성인 신증후군의 10–25%를 차지하며, 대량 단백뇨(>3.5 g/day)·저알부민혈증·부종·고지질혈증의 4대 신증후군 징후를 나타냅니다. 2023년 Beck 등(NEJM)이 MCD 환자 64%에서 항-네프린(anti-nephrin) IgG4 자가항체를 발견하면서, T세포 및 B세포 공동 병인이 재조명되고 있습니다.

### 병태생리 핵심 경로

| 경로 | 핵심 분자 | 결과 |
|------|----------|------|
| Th2 편중 면역 → 투과인자 | IL-4·IL-5·IL-13·IL-25·IL-33 | 가용성 투과인자(suPAR·hemopexin·CLC-1) 방출 |
| 항-네프린 IgG4 | Beck 2023 (NEJM), BCELL→형질세포 | 슬릿 다이어프램 Nephrin-Podocin 복합체 교란 |
| 족세포 액틴 불안정 | Cofilin-1, RhoA/Rac1/Cdc42, Synaptopodin | 족돌기 소실(FPE) → 여과 선택성 상실 |
| 사구체 여과 장벽 손상 | GBM·당칼릭스·슬릿 다이어프램 | 대량 단백뇨 (>3.5 g/day) |
| 저알부민혈증 → RAAS 활성 | Renin→AngII→Aldosterone, AQP2↑ | Na/수분 저류 → 부종 |
| 간 VLDL↑ / LPL↓ | ApoB-100·ApoCIII·PCSK9↑ | 고콜레스테롤혈증·고중성지방혈증 |
| AT-III·단백S·단백C 소실 | 응고 인자 불균형 | DVT/PE·신정맥혈전증 |

### 약물 PK/PD (Drug PK/PD Mechanisms)

| 약물 | 기전 | 주요 PK | 임상 근거 |
|------|------|---------|-----------|
| **프레드니솔론** | GR→NF-κB/AP-1 억제·Th2·CD4 증식↓ | F=82%, Vc=28L, CL=16.3L/h, EC50=2.5 ng/mL | KDIGO 2021: CR 88% at 12주 |
| **사이클로스포린(CsA)** | Calcineurin 억제 + 족세포 synaptopodin 직접 안정화 | F=35%, C0 목표 100–200 ng/mL | Faul 2008 (Nat Med) |
| **타크로리무스** | FK506-FKBP12→Calcineurin 차단→NFAT↓ | C0 목표 4–8 ng/mL, Vd=1100L | Tumlin 2006 |
| **리투시맙** | CD20+ B세포 고갈 98% (TMDD 모델)·항-네프린Ab↓ | Vc=3.5L, CL=0.008L/h, t½=22일 | Iijima 2014 (Lancet RCT) |
| **MMF/MPA** | IMPDH 억제→퓨린 합성 차단→B·T세포 증식↓ | t½=17h, EHC 30% | MYCYC trial 2017 |
| **사이클로포스파미드** | 4-OH-CP→DNA 알킬화→T·B세포 고갈 | 반응 2주, 2년 무재발 40–50% | Latta 2001 메타분석 |

### mrgsolve ODE 모델 구조

- **총 21개 ODE 구획** (9 PK + 5 면역/PD + 7 질환)
  - PK: DEPOT_PRED·PRED_C·PRED_P (프레드니솔론 3구획), CSA_GUT·CSA_C (사이클로스포린), TAC_GUT·TAC_C (타크로리무스), RTX_C·RTX_P (리투시맙 TMDD)
  - 면역/PD: CD4_EFF (Th2 편중 effector), TREG, BCELL, PERM_FACTOR (suPAR 유사), ANTI_NEPHRIN_AB
  - 질환: PODOCYTE (족세포 무결성 0–1), SLIT_DIAPHRAGM (nephrin 발현 0–1), PROTEINURIA (UPCR g/g), S_ALB (혈청 알부민 g/dL), EDEMA (부종 0–4), S_CHOL (총콜레스테롤 mg/dL), eGFR
- **6가지 치료 시나리오**: 무치료(자연경과) · Pred 단독(KDIGO 표준) · Pred+CsA · Pred+Tacrolimus · Rituximab+저용량Pred · CYC+Pred

### Shiny 앱 탭 구성

| # | 탭 | 주요 내용 |
|---|---|---------|
| 1 | 환자 프로파일 | 기저 단백뇨·알부민·eGFR·나이, KDIGO 중증도 레이더 차트, 위험 분류 패널 |
| 2 | PK 프로파일 | Pred·CsA·Tacro·Rituximab 농도-시간 그래프, CNI 치료 창 밴드, 용량-반응 곡선 |
| 3 | 면역 역학 | CD4+ effector T세포·Treg·B세포·suPAR 궤적, Treg/effector 비율, 면역 균형 차트 |
| 4 | 족세포 생물학 | 족세포 무결성 지수, Nephrin 발현, 족돌기 소실 중증도 게이지, 항-네프린 항체 시계열, 분자 마커 히트맵 |
| 5 | 임상 엔드포인트 | UPCR·혈청 알부민·콜레스테롤·부종 시계열, 완전관해(UPCR<0.3) 달성 시점, KPI valueBox |
| 6 | 시나리오 비교 | 6개 치료 전략 직접 비교 (Day-90 단백뇨 감소율, 완전관해율, 관해 도달 시간, 안전성/효과 레이더) |
| 7 | 바이오마커 패널 | 항-네프린 항체·뇨 네프린, 보체(C3/C4)·IgE·호산구, 바이오마커 상관 히트맵, 치료 결정 트리 |

### 핵심 임상시험 (Key Clinical Trials)

- **Beck 2023** (*NEJM*): MCD 환자 64%에서 항-네프린 IgG4 발견 — B세포/항체 병인 결정적 증거
- **RITAR-FP** (Iijima 2014, *Lancet*): 리투시맙 vs. 스테로이드+MMF → 18개월 무재발 66% vs. 27%
- **KDIGO 2021** 사구체 질환 가이드라인: 프레드니솔론 1 mg/kg/day (최대 80 mg), 최소 4주 → CR 88%
- **Faul 2008** (*Nat Med*): 사이클로스포린이 족세포 synaptopodin-cofilin 직접 안정화 — CNI의 족세포 직접 효과 규명
- **Wei 2011** (*Nat Med*): suPAR이 족세포 β3 인테그린 활성화 → 사구체 투과성 증가 — 투과인자 병인 확립

### 파일 목록

```
minimal-change-disease/
├── mcd_qsp_model.dot      # Graphviz 기계론적 지도 (213+ 노드, 17 클러스터)
├── mcd_qsp_model.svg      # SVG 벡터 이미지
├── mcd_qsp_model.png      # PNG 이미지 (150 dpi)
├── mcd_mrgsolve_model.R   # mrgsolve ODE 모델 (21 구획, 6 치료 시나리오)
├── mcd_shiny_app.R        # Shiny 대시보드 (7 탭, plotly 인터랙티브)
└── mcd_references.md      # 참고문헌 55개 (PubMed 링크, 13 섹션)
```