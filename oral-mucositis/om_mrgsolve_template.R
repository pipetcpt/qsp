...
lamS   : __LAMS__   : basal clonogen renewal rate (1/d)               <<FITTED>>
S0     : 1.0        : homeostatic clonogen density (normalised)
aS     : __AS__     : flux S -> P1 per unit S (1/d, normalisation-corrected)
...
greg   : __GREG__   : gain of the barrier-deficit -> proliferation loop <<FITTED>>
...
pot_mel: __POTMEL__ : melphalan potency on the clonogen pool           <<FITTED>>
pot_5fu: 12000: 5-FU potency on the clonogen pool                <<FITTED>>
pot_mtx: 0.085      : methotrexate potency
pot_cis: __POTCIS__ : cisplatin potency                                <<FITTED>>
...
rad_pot: __RADPOT__ : conversion of mucosal log-kill to clonogen loss   <<FITTED>>
...
#  scen_tbi <- function(cy_equiv = __CYEQ__, bsa = 1.8, pal = FALSE,
#                       wt = 75) {
#      dur <- 10/1440
...
#  #      lamS  = __LAMS__ * exp(rnorm(400, 0, 0.30) - 0.5 * 0.30^2),
